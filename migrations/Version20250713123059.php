 ...
 */
final class Version20250713123059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE marque CHANGE libelle libelle VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis CHANGE note note VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE marque CHANGE libelle libelle VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
